...
export const Cards = () => {
    return (
        <div className="cardsh grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4">
            <Card imgSrc={Smoke} className="filter transition ease-in-out duration-250  hover:shadow-xl hover:brightness-125">
            ...
            <Card imgSrc={FFire}  className="filter transition ease-in-out duration-250 hover:shadow-xl hover:brightness-125 brigh">
                    <h5 className="select-none text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Дымовые шлейфы
                    </h5>
                    <p className="select-none font-normal text-gray-700 dark:text-gray-400">
            ...
            <Card imgSrc={Cloud} className="filter transition ease-in-out duration-250 hover:shadow-xl hover:brightness-125">
                <h5 className="select-none text-xl font-bold tracking-tight text-gray-900 dark:text-white">
