        ...
        <div className="min-h-full flex items-center justify-center py-24 px-4 sm:px-6 lg:px-8">
            <Card>
                <div className="max-w-md w-full space-y-10">
                    <div>
                        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900 dark:text-white">Зарегистрируйте свой новый аккаунт</h2>
                        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-300">
                            <NavLink to="/signin">
                            Или войдите, если у вас уже есть аккаунт, для этого,
